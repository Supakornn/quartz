      ...
      <div class={classNames(displayClass, "recent-notes")}>
        <h3>
          ...
          <span class="see-more">
            ...
            <a
              href="https://github.com/Supakornn/notebook/commits/v4/content?author=Supakornn"
              class="external see-more"
            >
              see history
            </a>
            <svg
        ...
        <ul class="recent-ul">
          {pages
            .filter((page) => {
              ...
              return (
                !_excludeTags.some((tag) => page.frontmatter?.tags?.includes(tag)) &&
                page.frontmatter?.title !== "index"
              )
            })
            .slice(0, opts.limit)
            .map((page) => {
